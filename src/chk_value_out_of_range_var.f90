! chk_value_out_of_range_var.f90 --
...
!
!     The resulting values for x are different in the three cases.
!
program chk_value_out_of_range_var
    implicit none
    ...
    write(*, '(a)' )       'Original value contained in a variable - program runs fine'
...
end program chk_value_out_of_range_var
